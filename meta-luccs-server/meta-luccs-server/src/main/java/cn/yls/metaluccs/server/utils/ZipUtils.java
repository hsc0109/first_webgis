...
public class ZipUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        fileList.add(new File("/home/hanl/Data/yls/lulc2020/lc2020/01C_20200101-20210101.tif"));
        fileList.add(new File("/home/hanl/Data/yls/lulc2020/lc2020/01G_20200101-20210101.tif"));
        fileList.add(new File("/home/hanl/Data/yls/lulc2020/lc2020/01K_20200101-20210101.tif"));
        String fileName = new SimpleDateFormat("yyyyMMddHHmmssSSS") .format(new Date() );
        FileOutputStream fos2 = new FileOutputStream(new
                File("/home/hanl/Data/yls/"+fileName+".zip"));
